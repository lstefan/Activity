...
<body>
	...
	<div class="container">
		<div class="row text-center ">
			<div class="col-md-12">
				...
				<br>
				<h2>Activity</h2>
				<h5>Login yourself to get access to activities recommendations</h5>
				<br>
			</div>
		</div>
		<div class="row">
					...
					<div class="panel-body">
						<form:form
							...
							<div class="form-group input-group">
								...
								<form:input id="user-email" path="email" type="text"
							...
							<div class="form-group input-group">
								<span class="input-group-addon"><i class="fa fa-tag"></i></span>
								<form:input id="user-lastName" path="lastName" type="text"
							...
							<c:if test="${user.signInProvider == null}">
								...
								<div class="form-group input-group">
									...
									<form:password id="user-passwordVerification"
										path="passwordVerification" class="form-control"
							...
							<button id="btn-signup" type="submit" class="btn btn-success">
								<i class="icon-hand-right"></i>Register Me
							</button>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/resources/app/user.form.js"></script>
</body>
</html>	
