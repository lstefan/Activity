...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/assets/css/flexslider.css" />
...
<body class="home">
    ...
    <div class="row headline"><!-- Begin Headline -->
        ...
        ================================================== -->
         <div class="span8">
            <div id="slider" class="flexslider">
              <ul class="slides">
              	<c:forEach var="activity" items="${recentActivities}" varStatus="lineInfo">
              	    <spring:url value="/activities/{activityId}" var="activityUrl">
						<spring:param name="activityId" value="${activity.id}"/>
					</spring:url>
                	<li><a href="${fn:escapeXml(activityUrl)}"><img src="${pageContext.request.contextPath}/resources/images/${activity.image}" alt="slider" /></a></li>
                </c:forEach>
              </ul>
            </div>
        </div> 
        ...
        ================================================== -->
        <div class="span4">
        	<h3>Welcome ${pageContext.request.userPrincipal.name}!. <br /> </h3>
            <p class="lead">
				<a href="${pageContext.request.contextPath}/activities">Start rating activities</a><br><br>
				<a href="${pageContext.request.contextPath}/recommendations">View your recommendations</a>
			</p>
...
<!--             <a href="#"><i class="icon-plus-sign"></i>Read More</a>  -->
    ...
    <div class="row gallery-row"><!-- Begin Gallery Row --> 
    	...
    	<div class="span12">
            <h5 class="title-bg">Recent activities 
                <button class="btn btn-mini btn-inverse hidden-phone" onclick="window.location.href='${pageContext.request.contextPath}/activities'" type="button">View all</button>
            </h5>
