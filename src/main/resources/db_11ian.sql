...
INSERT INTO `user` VALUES (1,'livia.andreea.333@gmail.com','Livia','Ştefan',NULL,'USER','FACEBOOK'),(2,'test@gmail.com','Test','Test','$2a$10$vPNnxs4bxbQTCgCjIGurHuAOI/y9apHSSyiVv2DiC/bb/Mg6YGWMG','USER',NULL),(3,'test3@gmail.com','Test3','Test3','$2a$10$vPNnxs4bxbQTCgCjIGurHuAOI/y9apHSSyiVv2DiC/bb/Mg8YGWMG','USER',NULL),(4,'test4@gmail.com','Test4','Test4','$2a$10$vPNnxs4bxbQTCgCjIGurHuAOI/y9apHSSyiVv2DiC/bb/Mg7YGWMG','USER',NULL),(5,'test5@gmail.com','test5','test5','$2a$10$QDrtO6qAstB6ndgZHOrnWeIF76znDFciC7GzCS6E7cRb0G.2MaPqO','USER',NULL);
...
CREATE TABLE `user_rating` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_14qx4g5dmltbla50uofrgmm3v` (`activity_id`),
  KEY `FK_fp9oh6ow6sgdscdjety1qjai5` (`user_id`),
  CONSTRAINT `FK_14qx4g5dmltbla50uofrgmm3v` FOREIGN KEY (`activity_id`) REFERENCES `activity` (`activity_id`) ON UPDATE NO ACTION,
  CONSTRAINT `FK_fp9oh6ow6sgdscdjety1qjai5` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON UPDATE NO ACTION
...
INSERT INTO `user_rating` VALUES (1,4,1,1),(2,5,4,1),(3,1,6,1),(4,5,1,2),(5,5,2,2),(6,4,3,2),(7,2,4,3),(8,4,5,3),(9,5,6,3),(10,3,2,4),(11,3,7,4);
...
INSERT INTO `userconnection` VALUES ('livia.andreea.333@gmail.com','facebook','949557755077039',1,NULL,'http://facebook.com/profile.php?id=949557755077039','http://graph.facebook.com/v1.0/949557755077039/picture','CAAVjCLSnzq4BALbCoUg7ARYGg1Y231ZAzZCCVtiJZB3WSS72fZCWnZAZActEIYlK3JyZCut0a7PcQtaxWs96zo1lyPB495bBTGXrLgeBAllQZCJiPvSHgSTdv6PpcmexntwtTGMVnFIC7v5yln3brHQ5a2DZBRW7PfLy093v9rR9ZBHup5726H8vEbkrgTuQLZBtdAZD',NULL,NULL,1457612222371);
...
-- Dump completed on 2016-01-11  2:10:56
