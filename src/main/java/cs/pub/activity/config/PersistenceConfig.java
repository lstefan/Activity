 ...
 */
@Configuration
@ComponentScan("cs.pub.activity.repositories")
@EnableJpaRepositories("cs.pub.activity.repositories")
...
public class PersistenceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
    	...
    	entityManagerFactoryBean.setPersistenceUnitName("activity");
    	entityManagerFactoryBean.setPackagesToScan("cs.pub.activity.model");
