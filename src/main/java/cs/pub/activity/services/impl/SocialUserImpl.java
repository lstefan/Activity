 ...
 *
 */
public class SocialUserImpl extends SocialUser {
	...
	public SocialUserImpl(String username, String password, boolean enabled, boolean accountNonExpired, boolean credentialsNonExpired,
			boolean accountNonLocked, Collection<? extends GrantedAuthority> authorities) {

		super(username, password, enabled, accountNonExpired, credentialsNonExpired, accountNonLocked, authorities);
	}

	public SocialUserImpl(String username, String password, Set<GrantedAuthority> authotorities) {
	...
	public static class Builder {
		...
		public SocialUserImpl build() {
			SocialUserImpl user = new SocialUserImpl(username, password, authorities);
